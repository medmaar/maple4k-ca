...
export default function PrivacyPolicyPage() {
  return (
    <main style={{ background: "#0C0F1A", color: "#fff" }} className="min-h-screen py-20 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Maple4K", "item": "https://maple4k.ca"}, {"@type": "ListItem", "position": 2, "name": "Privacy Policy", "item": "https://maple4k.ca/privacy-policy"}]}) }} />
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10 text-black leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">To exercise these rights, contact us at <a href="mailto:help@maple4k.ca" className="text-[#F96E5B] hover:underline">help@maple4k.ca</a>.</p>
          </section>
