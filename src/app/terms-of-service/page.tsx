...
export default function TermsOfServicePage() {
  return (
    <main
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Maple4K", "item": "https://maple4k.ca"}, {"@type": "ListItem", "position": 2, "name": "Terms of Service", "item": "https://maple4k.ca/terms-of-service"}]}) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "WebPage", "name": "Terms of Service", "url": "https://maple4k.ca/terms-of-service", "inLanguage": "en-CA", "dateModified": "2026-07-19", "isPartOf": {"@type": "WebSite", "name": "Maple4K", "url": "https://maple4k.ca"}}) }} />
        ...
        <div className="space-y-10 text-black leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-transparent rounded-xl p-6 border border-gray-800">
              ...
              <p className="mt-2">WhatsApp: <a href="/link/wa" target="_blank" rel="noopener noreferrer" className="text-[#F96E5B] hover:underline">WhatsApp</a></p>
            </div>
          </section>
        </div>
      </div>
