...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    {"@type":"Question","name":"What's included in a Maple4K IPTV subscription?","acceptedAnswer":{"@type":"Answer","text":"Every Maple4K IPTV subscription includes 50,000+ channels + Netflix, 120,000+ on-demand movies and series, True 4K Ultra HD quality, 7-day catch-up TV, and full EPG guide on all devices."}},
    ...
    <main style={{ background: "#0C0F1A", color: "#fff", minHeight: "100vh" }}>
      ...
      <section style={{ maxWidth: 900, margin: "0 auto", padding: "0 16px 80px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(240px,1fr))", gap: 12 }}>
          {["50,000+ Channels + Netflix","120,000+ Movies & Series","True 4K Ultra HD","H.265/HEVC Streams","7-Day Catch-Up TV","Full EPG Guide","Multi-Device Options","24/7 Canadian Support","Free Setup Assistance"].map(f => (
