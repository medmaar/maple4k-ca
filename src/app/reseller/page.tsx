    ...
    <main style={{ background: "#0C0F1A", color: "#fff", minHeight: "100vh" }}>
      ...
      >
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          <span style={{ display: "inline-block", background: "rgba(229,57,53,0.12)", border: "1px solid rgba(229,57,53,0.3)", color: "#E8041F", fontSize: 12, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", padding: "6px 18px", borderRadius: 999, marginBottom: 28 }}>
      ...
      <section style={{ padding: "80px 16px", background: "#E8F4F5" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 24 }}>
            {features.map((f) => (
              <div key={f.title} style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.09)", borderRadius: 20, padding: "36px 28px", textAlign: "center" }}>
                <div style={{ fontSize: 40, marginBottom: 16 }}>{f.icon}</div>
                <h3 style={{ fontWeight: 800, fontSize: 18, marginBottom: 12, color: "#fff" }}>{f.title}</h3>
                <p style={{ color: "#fff", fontSize: 14, lineHeight: 1.7 }}>{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: "80px 16px", background: "#E8F4F5" }}>
        <div style={{ maxWidth: 780, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            {[
              { n: "01", title: "Contact Us to Apply", desc: "Email help@maple4k.ca with your reseller inquiry. We'll respond within minutes with pricing and details." },
              ...
              <div key={s.n} style={{ display: "flex", gap: 20, background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.09)", borderRadius: 14, padding: "22px 28px" }}>
                <span style={{ color: "#E8041F", fontWeight: 900, fontSize: 24, opacity: 0.5, minWidth: 40 }}>{s.n}</span>
                <div>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 20 }}>
            {[
              ...
              <div key={f.title} style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.09)", borderRadius: 16, padding: "24px 20px" }}>
                <h3 style={{ fontWeight: 700, fontSize: 15, marginBottom: 8, color: "#E8041F" }}>{f.title}</h3>
                <p style={{ color: "#fff", fontSize: 13, lineHeight: 1.6 }}>{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* CTA */}
      <section style={{ padding: "80px 16px", textAlign: "center", background: "rgba(255,255,255,0.05)" }}>
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          <h2 style={{ fontSize: "clamp(26px, 4vw, 40px)", fontWeight: 900, marginBottom: 16 }}>
            Ready to Start Your IPTV Business?
          </h2>
          <p style={{ color: "#fff", marginBottom: 36, fontSize: 16, lineHeight: 1.7 }}>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
            <a
              href="mailto:help@maple4k.ca?subject=IPTV%20Reseller%20Inquiry"
              style={{ background: "#E8041F", color: "#fff", fontWeight: 700, fontSize: 16, padding: "16px 36px", borderRadius: 14, textDecoration: "none", display: "inline-block" }}
            >
              Email Us to Apply →
            </a>
            <Link
              href="/pricing"
              style={{ background: "transparent", border: "2px solid rgba(229,57,53,0.4)", color: "#E8041F", fontWeight: 700, fontSize: 16, padding: "16px 36px", borderRadius: 14, textDecoration: "none", display: "inline-block" }}
            >
              View Retail Plans
            </Link>
          </div>
          <p style={{ color: "#4b5563", fontSize: 13, marginTop: 20 }}>
            help@maple4k.ca · Respond within minutes
          </p>
        </div>
      </section>
    </main>
