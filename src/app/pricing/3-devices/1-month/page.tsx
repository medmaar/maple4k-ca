...
export const metadata: Metadata = {
  title: "3 Device 1 Month IPTV Plan — $27 | Maple4K Canada",
  description:
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              >
                Maple4K · 3 Devices · 1 Month
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white">
                3 Devices 1 Month Plan —{" "}
                <span style={{ color: "#fd0322" }}>$27</span>
              </h1>
            </div>
            ...
            >
              <PlanOrderForm plan="3 Devices - 1 Month — $27" />
            </div>
