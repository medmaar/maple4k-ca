...
export const metadata: Metadata = {
  title: "1 Month - 3 Devices IPTV Plan — $27 | Maple4K Canada",
  description:
    "Get 3 simultaneous connections for $27. 25,000+ live channels, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within 24 hours.",
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: 12, marginTop: 10 }}>
                <del style={{ color: "#6b7280", fontSize: "1.1rem" }}>$54</del>
                <span style={{ color: "#fd0322", fontWeight: 700, fontSize: "2rem" }}>$27</span>
              </div>
            </div>
