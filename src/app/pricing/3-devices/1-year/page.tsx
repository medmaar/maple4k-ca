...
export const metadata: Metadata = {
  title: { absolute: "3 Connections IPTV Canada 1 Year — $135 | Maple4K" },
  description:
    "Get 3 simultaneous connections for $135. 50,000+ channels + Netflix, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within minutes.",
  alternates: { canonical: "https://maple4k.ca/pricing/3-devices/1-year" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "Maple4K 1 Year IPTV Plan — 3 Devices",
  description: "1 Year of IPTV access for 3 simultaneous connections. 50,000+ channels + Netflix in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maple4k.ca/pricing/3-devices/1-year",
    "shippingDetails": {
