...
export const metadata: Metadata = {
  title: "4 Device IPTV Plans | Maple4K Canada",
  description:
    "Stream on 4 devices simultaneously. Maple4K IPTV plans for 4 connections from $36/month. 25,000+ channels, 4K, NHL, TSN, CTV included.",
  alternates: { canonical: "https://maple4k.ca/pricing/4-devices" },
};

const plans = [
  { label: "1 Month",   price: 36  },
  { label: "3 Months",  price: 99  },
  { label: "6 Months",  price: 140 },
  { label: "12 Months", price: 180 },
];

export default function FourDevicesPage() {
  return (
        ...
        <div className="max-w-2xl mx-auto">
          <div className="mb-10">
            ...
            <p className="text-gray-400 text-sm mt-3">
              Stream on 4 devices at the same time. Select a plan below and fill out the form to order.
            </p>
          </div>
          ...
          {plans.map((plan) => (
            <div key={plan.label} className="mb-16">
              ...
              >
                <PlanOrderForm plan={`4 Devices - ${plan.label} — $${plan.price}`} />
              </div>
            </div>
          ))}
        </div>
