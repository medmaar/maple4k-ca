...
export const metadata: Metadata = {
  title: "4 Device 1 Month IPTV Plan — $36 | Maple4K Canada",
  description:
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              >
                Maple4K · 4 Devices · 1 Month
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white">
                4 Devices 1 Month Plan —{" "}
                <span style={{ color: "#fd0322" }}>$36</span>
              </h1>
            </div>
            ...
            >
              <PlanOrderForm plan="4 Devices - 1 Month — $36" />
            </div>
