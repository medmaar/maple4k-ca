...
export const metadata: Metadata = {
  ...
  description:
    "Get 4 simultaneous connections for $140. 50,000+ channels + Netflix, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within minutes.",
...
const productSchema = {
  ...
  description: "6 Months of IPTV access for 4 simultaneous connections. 50,000+ channels + Netflix in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
