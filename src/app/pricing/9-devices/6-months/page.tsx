...
export const metadata: Metadata = {
  title: "9 Device 6 Months IPTV Plan — $315 | Maple4K Canada",
  description:
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              >
                Maple4K · 9 Devices · 6 Months
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white">
                9 Devices 6 Months Plan —{" "}
                <span style={{ color: "#fd0322" }}>$315</span>
              </h1>
            </div>
            ...
            >
              <PlanOrderForm plan="9 Devices - 6 Months — $315" />
            </div>
