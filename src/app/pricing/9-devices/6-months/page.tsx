...
export const metadata: Metadata = {
  title: { absolute: "9 Connections IPTV Canada 6 Months — $315 | Maple4K" },
  description:
    "Get 9 simultaneous connections for $315. 50,000+ channels + Netflix, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within minutes.",
  alternates: { canonical: "https://maple4k.ca/pricing/9-devices/6-months" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "Maple4K 6 Months IPTV Plan — 9 Devices",
  description: "6 Months of IPTV access for 9 simultaneous connections. 50,000+ channels + Netflix in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maple4k.ca/pricing/9-devices/6-months",
    "shippingDetails": {
