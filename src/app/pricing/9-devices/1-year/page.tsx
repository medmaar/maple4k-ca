...
export const metadata: Metadata = {
  title: "9 Device 1 Year IPTV Plan — $405 | Maple4K Canada",
  description:
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              >
                Maple4K · 9 Devices · 1 Year
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white">
                9 Devices 1 Year Plan —{" "}
                <span style={{ color: "#fd0322" }}>$405</span>
              </h1>
            </div>
            ...
            >
              <PlanOrderForm plan="9 Devices - 1 Year — $405" />
            </div>
