...
export const metadata: Metadata = {
  title: { absolute: "9 Connections IPTV Canada 3 Months — $216 | Maple4K" },
  description:
    "Get 9 simultaneous connections for $216. 50,000+ channels + Netflix, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within minutes.",
  alternates: { canonical: "https://maple4k.ca/pricing/9-devices/3-months" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "Maple4K 3 Months IPTV Plan — 9 Devices",
  description: "3 Months of IPTV access for 9 simultaneous connections. 50,000+ channels + Netflix in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maple4k.ca/pricing/9-devices/3-months",
    "shippingDetails": {
