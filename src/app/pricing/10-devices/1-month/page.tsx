...
const productSchema = {
  ...
  description: "1 Month of IPTV access for 10 simultaneous connections. 50,000+ channels + Netflix in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in.",
