...
export const metadata: Metadata = {
  title: { absolute: "10 Connections IPTV Canada 6 Months — $350 | Maple4K" },
  description:
    "Get 10 simultaneous connections for $350. 50,000+ channels + Netflix, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within minutes.",
  alternates: { canonical: "https://maple4k.ca/pricing/10-devices/6-months" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "Maple4K 6 Months IPTV Plan — 10 Devices",
  description: "6 Months of IPTV access for 10 simultaneous connections. 50,000+ channels + Netflix in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maple4k.ca/pricing/10-devices/6-months",
    "shippingDetails": {
