...
export const metadata: Metadata = {
  title: "10 Device 1 Year IPTV Plan — $450 | Maple4K Canada",
  description:
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              >
                Maple4K · 10 Devices · 1 Year
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white">
                10 Devices 1 Year Plan —{" "}
                <span style={{ color: "#fd0322" }}>$450</span>
              </h1>
            </div>
            ...
            >
              <PlanOrderForm plan="10 Devices - 1 Year — $450" />
            </div>
