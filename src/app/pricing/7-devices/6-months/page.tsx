...
export const metadata: Metadata = {
  title: "7 Device 6 Months IPTV Plan — $245 | Maple4K Canada",
  description:
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              >
                Maple4K · 7 Devices · 6 Months
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white">
                7 Devices 6 Months Plan —{" "}
                <span style={{ color: "#fd0322" }}>$245</span>
              </h1>
            </div>
            ...
            >
              <PlanOrderForm plan="7 Devices - 6 Months — $245" />
            </div>
