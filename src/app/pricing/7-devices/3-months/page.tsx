...
export const metadata: Metadata = {
  title: "7 Device 3 Months IPTV Plan — $168 | Maple4K Canada",
  description:
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              >
                Maple4K · 7 Devices · 3 Months
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white">
                7 Devices 3 Months Plan —{" "}
                <span style={{ color: "#fd0322" }}>$168</span>
              </h1>
            </div>
            ...
            >
              <PlanOrderForm plan="7 Devices - 3 Months — $168" />
            </div>
