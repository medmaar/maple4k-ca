...
const productSchema = {
  ...
  description: "3 Months of IPTV access for 7 simultaneous connections. 50,000+ channels + Netflix in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in.",
