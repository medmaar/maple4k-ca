...
export const metadata: Metadata = {
  title: "7 Device 1 Month IPTV Plan — $63 | Maple4K Canada",
  description:
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              >
                Maple4K · 7 Devices · 1 Month
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white">
                7 Devices 1 Month Plan —{" "}
                <span style={{ color: "#fd0322" }}>$63</span>
              </h1>
            </div>
            ...
            >
              <PlanOrderForm plan="7 Devices - 1 Month — $63" />
            </div>
