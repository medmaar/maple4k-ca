...
export const metadata: Metadata = {
  title: "6 Device 1 Year IPTV Plan — $270 | Maple4K Canada",
  description:
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              >
                Maple4K · 6 Devices · 1 Year
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white">
                6 Devices 1 Year Plan —{" "}
                <span style={{ color: "#fd0322" }}>$270</span>
              </h1>
            </div>
            ...
            >
              <PlanOrderForm plan="6 Devices - 1 Year — $270" />
            </div>
