...
export const metadata: Metadata = {
  title: "6 Device 1 Month IPTV Plan — $54 | Maple4K Canada",
  description:
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              >
                Maple4K · 6 Devices · 1 Month
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white">
                6 Devices 1 Month Plan —{" "}
                <span style={{ color: "#fd0322" }}>$54</span>
              </h1>
            </div>
            ...
            >
              <PlanOrderForm plan="6 Devices - 1 Month — $54" />
            </div>
