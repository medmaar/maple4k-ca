...
export const metadata: Metadata = {
  title: "6 Device 3 Months IPTV Plan — $144 | Maple4K Canada",
  description:
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              >
                Maple4K · 6 Devices · 3 Months
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white">
                6 Devices 3 Months Plan —{" "}
                <span style={{ color: "#fd0322" }}>$144</span>
              </h1>
            </div>
            ...
            >
              <PlanOrderForm plan="6 Devices - 3 Months — $144" />
            </div>
