...
export const metadata: Metadata = {
  title: "6 Device 6 Months IPTV Plan — $210 | Maple4K Canada",
  description:
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              >
                Maple4K · 6 Devices · 6 Months
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white">
                6 Devices 6 Months Plan —{" "}
                <span style={{ color: "#fd0322" }}>$210</span>
              </h1>
            </div>
            ...
            >
              <PlanOrderForm plan="6 Devices - 6 Months — $210" />
            </div>
