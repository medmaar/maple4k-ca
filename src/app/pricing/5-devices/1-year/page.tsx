...
export const metadata: Metadata = {
  title: { absolute: "5 Connections IPTV Canada 1 Year — $225 | Maple4K" },
  description:
    "Get 5 simultaneous connections for $225. 50,000+ channels + Netflix, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within minutes.",
  alternates: { canonical: "https://maple4k.ca/pricing/5-devices/1-year" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "Maple4K 1 Year IPTV Plan — 5 Devices",
  description: "1 Year of IPTV access for 5 simultaneous connections. 50,000+ channels + Netflix in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maple4k.ca/pricing/5-devices/1-year",
    "shippingDetails": {
