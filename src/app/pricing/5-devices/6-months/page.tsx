...
export const metadata: Metadata = {
  title: "6 Months - 5 Devices IPTV Plan — $175 | Maple4K Canada",
  description:
    "Get 5 simultaneous connections for $175. 25,000+ live channels, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within 24 hours.",
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: 12, marginTop: 10 }}>
                <del style={{ color: "#6b7280", fontSize: "1.1rem" }}>$350</del>
                <span style={{ color: "#fd0322", fontWeight: 700, fontSize: "2rem" }}>$175</span>
              </div>
            </div>
