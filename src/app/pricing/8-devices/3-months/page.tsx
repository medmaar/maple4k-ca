...
export const metadata: Metadata = {
  title: "8 Device 3 Months IPTV Plan — $192 | Maple4K Canada",
  description:
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              >
                Maple4K · 8 Devices · 3 Months
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white">
                8 Devices 3 Months Plan —{" "}
                <span style={{ color: "#fd0322" }}>$192</span>
              </h1>
            </div>
            ...
            >
              <PlanOrderForm plan="8 Devices - 3 Months — $192" />
            </div>
