...
export const metadata: Metadata = {
  title: { absolute: "8 Connections IPTV Canada 1 Year — $360 | Maple4K" },
  description:
...
const productSchema = {
  ...
  description: "1 Year of IPTV access for 8 simultaneous connections. 50,000+ channels + Netflix in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
