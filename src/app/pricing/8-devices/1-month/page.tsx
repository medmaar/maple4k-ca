...
export const metadata: Metadata = {
  title: { absolute: "8 Connections IPTV Canada 1 Month — $72 | Maple4K" },
  description:
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "Maple4K 1 Month IPTV Plan — 8 Devices",
  description: "1 Month of IPTV access for 8 simultaneous connections. 50,000+ channels + Netflix in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maple4k.ca/pricing/8-devices/1-month",
    "shippingDetails": {
