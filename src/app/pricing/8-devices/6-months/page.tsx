...
const productSchema = {
  ...
  description: "6 Months of IPTV access for 8 simultaneous connections. 50,000+ channels + Netflix in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in.",
