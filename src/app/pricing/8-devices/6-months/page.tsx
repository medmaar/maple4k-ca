...
export const metadata: Metadata = {
  title: "6 Months - 8 Devices IPTV Plan — $280 | Maple4K Canada",
  description:
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: 12, marginTop: 10 }}>
                <del style={{ color: "#6b7280", fontSize: "1.1rem" }}>$560</del>
                <span style={{ color: "#fd0322", fontWeight: 700, fontSize: "2rem" }}>$280</span>
              </div>
            </div>
