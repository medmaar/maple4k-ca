...
export const metadata: Metadata = {
  title: "8 Device 6 Months IPTV Plan — $280 | Maple4K Canada",
  description:
    "Get 8 simultaneous connections for $280. 25,000+ live channels, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within 24 hours.",
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="mb-8">
              ...
              >
                Maple4K · 8 Devices · 6 Months
              </span>
              <h1 className="text-4xl md:text-5xl font-extrabold text-white">
                8 Devices 6 Months Plan —{" "}
                <span style={{ color: "#fd0322" }}>$280</span>
              </h1>
            </div>
            ...
            >
              <PlanOrderForm plan="8 Devices - 6 Months — $280" />
            </div>
