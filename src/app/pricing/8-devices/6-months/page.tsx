...
export const metadata: Metadata = {
  title: { absolute: "8 Connections IPTV Canada 6 Months — $280 | Maple4K" },
  description:
    "Get 8 simultaneous connections for $280. 50,000+ channels + Netflix, 4K quality, NHL, TSN, CTV and more. No contract. Credentials sent within minutes.",
  alternates: { canonical: "https://maple4k.ca/pricing/8-devices/6-months" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "Maple4K 6 Months IPTV Plan — 8 Devices",
  description: "6 Months of IPTV access for 8 simultaneous connections. 50,000+ channels + Netflix in Canada including NHL, TSN, CTV, Sportsnet and 120,000+ VOD titles in 4K.",
  ...
  offers: {
    ...
    url: "https://maple4k.ca/pricing/8-devices/6-months",
    "shippingDetails": {
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div style={{ background: "rgba(255,255,255,0.05)", borderRadius: 24, padding: "28px 24px", boxShadow: "0 8px 32px rgba(26,61,69,0.25)", marginBottom: 24, textAlign: "center" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 14, marginBottom: 16 }}>
                <span style={{ color: "#E8041F", fontWeight: 900, fontSize: "2.4rem" }}>Price : $280</span>
