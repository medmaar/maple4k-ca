...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    {"@type":"ListItem","position":3,"name":"Iptv Vs Cable Canada","item":"https://maple4k.ca/blog/iptv-vs-cable-canada"}
  ]
};
      ...
      <main style={{ background: "#030712", color: "#fff", minHeight: "100vh" }}>
        <article style={{ maxWidth: 768, margin: "0 auto", padding: "64px 16px" }}>
          ...
          <div style={{ marginBottom: 16, display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
            ...
            <time dateTime="2026-02-20" style={{ color: "#fff", fontSize: 14 }}>February 20, 2026</time>
            <span style={{ color: "#fff", fontSize: 14 }}>6 min read</span>
          </div>
          ...
          <section style={{ marginBottom: 48 }}>
            ...
            <p style={{ color: "#d1d5db", fontSize: 14, lineHeight: 1.75 }}>
              View all <Link href="/pricing" style={{ color: "#E8041F", textDecoration: "none", fontWeight: 600 }}>Maple4K plans</Link> with full pricing details.
            </p>
          </section>
            ...
            <div style={{ overflowX: "auto", borderRadius: 16, border: "1px solid #1f2937" }}>
              <table style={{ width: "100%", fontSize: 14, borderCollapse: "collapse" }}>
                <thead style={{ background: "#111827" }}>
                  <tr>
                    <th style={{ textAlign: "left", padding: "12px 16px", color: "#fff" }}>Feature</th>
                    ...
                    <th style={{ textAlign: "left", padding: "12px 16px", color: "#fff" }}>Winner</th>
                  </tr>
                </thead>
                <tbody>
                  {comparison.map((row) => (
          ...
          <div style={{ borderTop: "1px solid #1f2937", paddingTop: 32, display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <Link href="/blog/is-iptv-legal-canada" style={{ color: "#E8041F", textDecoration: "none", fontSize: 15 }}>
              → Is IPTV Legal in Canada in 2026?
            </Link>
            <Link href="/blog/best-iptv-player-canada" style={{ color: "#E8041F", textDecoration: "none", fontSize: 15 }}>
              → Best IPTV Player Apps for Canada in 2026
            </Link>
            <Link href="/blog/best-iptv-canada-2026" style={{ color: "#E8041F", textDecoration: "none", fontSize: 15 }}>
